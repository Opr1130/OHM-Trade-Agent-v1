...
# Verified screening-archive segments drained per Discovery cycle (bounded).
DISCOVERY_SCREENING_ARCHIVE_SEGMENTS_PER_CYCLE = 2
DISCOVERY_HOT_GENERATION_PREFIX_BYTES = 65536
