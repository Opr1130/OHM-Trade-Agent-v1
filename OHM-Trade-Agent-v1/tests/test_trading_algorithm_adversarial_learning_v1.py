...
def test_movement_discovery_horizon_excludes_candle_not_fully_completed_by_end():
    # For a 1h horizon ending at 13:00, a Kraken candle timestamped 13:00
    # represents 13:00-13:15 and must not contribute any future minutes.
    candles = [
...
def test_price_movement_delayed_scheduler_uses_exact_horizon_not_current_ticker(monkeypatch, tmp_path):
    ...
    class Client:
        def get_tickers(self, symbols):
            # Current price 30 minutes after the 1h horizon: a large later move.
        ...
        def get_ohlc(self, symbol, interval, since=None):
            # Exact 1h horizon price was 105, before the later jump.
            return [
