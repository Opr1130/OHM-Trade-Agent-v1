...
# Only executable cron content is authoritative. Scan the complete file in one
# pass so pipefail/SIGPIPE cannot turn a real forbidden-lock match into success.
